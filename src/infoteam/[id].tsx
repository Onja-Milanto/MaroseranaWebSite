...
const InfoTeam: React.FC = () => {
  ...
  // Extended team data with detailed information
  const allMembers = [
    {
      id: 1,
    ...
    },
    {
      ...
      email: "jsp@maroserana.org",
      phone: "+261 34 78 901 23",
      location: "Toliara, Madagascar",
      joinDate: "2021-06-01",
      specialties: ["Recherche", "Enseignement"],
      education: ["Master en Sciences - Université de Toliara"],
      achievements: ["Participation active aux projets de recherche"],
      description: "Membre actif du conseil d'administration de l'UC MaroSerana.",
    },
    {
      id: 8,
      ...
      bio: "Professeur et chercheur.",
      email: "ravaka.razafintseheno@maroserana.org",
      phone: "+261 34 89 012 34",
      location: "Toliara, Madagascar",
      joinDate: "2021-07-15",
      specialties: ["Enseignement", "Recherche académique"],
      education: ["Doctorat - Université de Toliara"],
      achievements: ["Publications scientifiques", "Encadrement d'étudiants"],
      description: "Professeur expérimenté contribuant à la formation et à la recherche.",
    },
    {
      id: 9,
      ...
      bio: "Spécialiste en informatique et technologies.",
      email: "milanto.rabarinarivo@maroserana.org",
      phone: "+261 34 90 123 45",
      location: "Toliara, Madagascar",
      joinDate: "2021-08-01",
      specialties: ["Informatique", "Développement web", "Bases de données"],
      education: ["Master en Informatique - Université d'Antananarivo"],
      achievements: [
        "Développement du site web de l'UC MaroSerana",
        "Mise en place de systèmes informatiques",
        "Formation en technologies numériques",
      ],
      description:
        "Milanto RABARINARIVO gère l'infrastructure informatique de l'UC MaroSerana et développe les outils numériques de l'organisation.",
    },
    {
      id: 10,
      name: "jsp",
      ...
      bio: "Membre du conseil.",
      email: "jsp2@maroserana.org",
      phone: "+261 34 01 234 56",
      location: "Toliara, Madagascar",
      joinDate: "2021-09-01",
      specialties: ["Recherche"],
      education: ["Master - Université de Toliara"],
      achievements: ["Contributions à la recherche"],
      description: "Membre actif du conseil de l'UC MaroSerana.",
    },
    {
      id: 11,
      name: "jsp",
      ...
      bio: "Spécialiste en climat, géomatique, SIG et environnement.",
      email: "jsp3@maroserana.org",
      phone: "+261 34 12 345 67",
      location: "Toliara, Madagascar",
      joinDate: "2021-10-01",
      specialties: ["Climatologie", "Géomatique", "SIG", "Environnement"],
      education: ["Master en Géomatique - Université de Toliara"],
      achievements: ["Projets de cartographie", "Études climatiques"],
      description: "Expert en géomatique et systèmes d'information géographique.",
    },
    {
      id: 12,
      name: "Diva",
      ...
      bio: "Professeur et chercheur.",
      email: "diva@maroserana.org",
      phone: "+261 34 23 456 78",
      location: "Toliara, Madagascar",
      joinDate: "2021-11-01",
      specialties: ["Enseignement", "Recherche"],
      education: ["Master - Université de Toliara"],
      achievements: ["Publications", "Encadrement"],
      description: "Professeur dévoué à l'enseignement et à la recherche.",
    },
    {
      id: 13,
      ...
      bio: "Responsable de la rédaction et de la communication écrite.",
      email: "miangola.rabarinarivo@maroserana.org",
      phone: "+261 34 34 567 89",
      location: "Toliara, Madagascar",
      joinDate: "2021-12-01",
      specialties: ["Rédaction", "Communication", "Édition"],
      education: ["Master en Communication - Université d'Antananarivo"],
      achievements: ["Rédaction de rapports scientifiques", "Coordination éditoriale", "Développement de contenus"],
      description:
        "Miangola RABARINARIVO est responsable de la rédaction et de l'édition des publications de l'UC MaroSerana.",
    },
    {
      id: 14,
      name: "Ullah",
      ...
      bio: "Professeur et membre du conseil.",
      email: "ullah@maroserana.org",
      phone: "+261 34 45 678 90",
      location: "Toliara, Madagascar",
      joinDate: "2022-01-01",
      specialties: ["Enseignement", "Conseil"],
      education: ["Master - Université de Toliara"],
      achievements: ["Contributions académiques"],
      description: "Professeur expérimenté et conseiller de l'UC MaroSerana.",
    },
  ]

  const member = allMembers.find((m) => m.id === Number.parseInt(id || "0"))

  if (!member) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-800 mb-4">{t("infoteam.memberNotFound", "Membre non trouvé")}</h1>
          <NavLink to="/about">
            <Button variant="primary">{t("infoteam.backToTeam", "Retour à l'équipe")}</Button>
          </NavLink>
        </div>
      </div>
    )
