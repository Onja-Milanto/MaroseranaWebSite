...
const InfoTeam1: React.FC = () => {
  ...
  const member = {
    ...
    achievements: [
      "Président de l'Université de Toliara",
      "Auteur de 15+ publications scientifiques",
      "Coordinateur de 5 projets internationaux",
      "Expert consultant pour l'UNESCO",
    ],
    description:
      "Francis Veriza est Maître de Conférences en géographie, qualifié par le CNU (section 23). Il a préparé sa thèse de doctorat entre 2014 et 2019, soutenue en juin 2019 dans le cadre d’une cotutelle entre l’Université Bordeaux Montaigne (France) et l’Université de Toliara (Madagascar). Depuis 2022, il est chercheur associé à l’UMR Passages 5319 du CNRS. Ses travaux portent sur les dynamiques territoriales, les communautés vezo, la conservation environnementale et les enjeux de développement dans le sud-ouest de Madagascar. Entré dans l’enseignement supérieur en 2011 en tant qu’assistant, il a enseigné dans plusieurs universités, dont Antsiranana, Fianarantsoa, Toliara et Bordeaux. Il participe activement à plusieurs projets de recherche de portée nationale et internationale, tels que Madatlas, Corecrabe, VectoPlastique et l’Observatoire Makay, en partenariat avec l’IRD, en particulier l’UMR SENS de Montpellier. Il contribue également à l’animation scientifique de la Communauté des Savoirs Littoral et Océan (CoSAv LEO) de l’IRD. Il est l’auteur d’une dizaine de publications scientifiques dont La Petite Encyclopédie du Grand Sud, coécrit avec Jean-Michel Lebigre et d’une soixantaine de communications. Après sa thèse à l’Université Bordeaux Montaigne, il a assumé, de 2019 à 2025, les fonctions de Directeur des affaires administratives et financières de l’Université de Toliara, tout en supervisant les examens du baccalauréat. En mars 2025, il a été élu président de l’université. ",
  }
