...
const InfoTeam2: React.FC = () => {
  ...
  const member = {
    id: 12,
    name: "Mme ELINAH Toziny Viva",
    title: "Membre de l'UC MaroSerana",
    image: "../../../images/viva.jpg",
    bio: "Masterant en Géographie sociale, Assistant Académique en Géographie.",
    email: "tozinyviva@maroserana.org",
    phone: "+261 38 19 071 40 ",
    location: "Toliara, Madagascar",
    joinDate: "2019-03-10",
    specialties: ["Genre", "Insécurité alimentaire", "Ethno- écologie"],
    education: [
    ...
    description:
"ELIANAH Toziny Viva, doctorante en géographie sociale à l’Ecole Doctorale thématique Lettres – Humanités – Indépendance Culturelle (EDLHIC) de l’université de Toliara. Elle enseigne le module de Gestion des risques et des catastrophes aux étudiants L3 de la Mention Droit, Parcours Environnement, à l’Université de Toliara.Les recherches doctorales se focalisent sur le thème de l’insécurité alimentaires avec une approche fortement genrée. Les publications et communications déjà effectuées se convergent sur la question du genre dans les dynamiques sociales, culturelles, économiques."  }
